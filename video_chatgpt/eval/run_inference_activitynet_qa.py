...
from video_chatgpt.eval.model_utils import initialize_model, load_video, load_frames
...
def parse_args():
    ...
    parser.add_argument('--prompt', help='prompt to prepend before the question', default='')
...
def run_inference(args):
    ...
    for sample in tqdm(gt_questions):
        ...
        question = args.prompt + sample['question']
